    ...
    <div class="row g-4">
        ...
        <div class="col-6 col-md-4 col-lg-3">
            <div class="product-card h-100 bg-white rounded-4 overflow-hidden position-relative"
                ...
                {{-- Wishlist --}}
                <button class="position-absolute top-0 end-0 m-3 border-0 bg-white rounded-circle d-flex align-items-center justify-content-center wishlist-btn"
                ...
                <div class="p-3">
                    ...
                    <div class="mt-3 d-flex gap-2">
                        <a href="#"
                           class="btn flex-fill fw-semibold btnView"
...
@section('customJS')
    <script src="{{ asset('controllers/show-product.js') }}?v={{ filemtime(public_path('controllers/show-product.js')) }}"></script>
@endsection
