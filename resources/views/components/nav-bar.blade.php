        ...
        <div class="d-flex gap-2">
            ...
            <div class="position-relative w-100">
                <input type="text" class="form-control form-control-lg border-0 shadow-sm rounded-4 ps-5"
                    placeholder="Search for products, categories or brands..." style="font-size: 0.95rem;" id="txtSearch" name="txtSearch">
            ...
            <button class="btn btn-dark btn-lg shadow-sm rounded-4 px-4" type="button" id="btnSearch" name="btnSearch" style="font-size: 0.95rem; white-space: nowrap;">
                Search
            </button>
